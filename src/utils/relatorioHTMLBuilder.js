 ...
 * Função que converte dados em HTML puro (sem JSX)
...
/**
 * Gera HTML consolidado a partir dos dados
 * Este é o "lado servidor" - converte dados para HTML puro
 */
export const gerarHTMLRelatorio = (data = {}) => {
  const {
    ...
    <body>
      ...
      <div class="container">
        <div class="header-gradient text-white p-6" style="border-radius: 0.5rem; margin-bottom: 2rem; text-align: center;">
          <h1 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 0.5rem;">GRAXA</h1>
          <h2 style="font-size: 1.5rem; font-weight: 300; margin-bottom: 1.5rem;">Relatório de Evento</h2>
...
export default gerarHTMLRelatorio;
