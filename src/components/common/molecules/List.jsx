...
export const List = ({
  ...
  <div
    onClick={onClick}
    className={`flex items-center w-full gap-4 p-4 surface-card hover:border-[var(--border-hover)] transition-all duration-200 cursor-pointer ${isSelected ? "border-[var(--accent)] border-2" : ""}`}
  >
