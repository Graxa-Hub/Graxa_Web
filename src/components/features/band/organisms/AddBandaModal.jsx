...
import { BandaFormStep } from "./BandaFormStep";
import { IntegranteFormStep } from "./IntegranteFormStep";
...
export function AddBandaModal({
    ...
    const {
        isEditMode, draft, errors, loading, imagemAtual,
        handleChange, handleIntegranteChange,
        adicionarIntegrante, removerIntegrante,
        handleFinish,
        representantes, showNovoRepresentante, setShowNovoRepresentante,
