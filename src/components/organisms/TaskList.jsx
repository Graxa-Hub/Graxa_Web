    ...
    <>
      ...
      >
        <button
          ...
          className="w-full h-[48px] flex items-center justify-between px-4 text-[var(--text-primary)] font-semibold text-sm flex-shrink-0 bg-[var(--surface)] hover:bg-[var(--surface-hover)] cursor-pointer border-b border-transparent data-[expanded=true]:border-[var(--border)]"
              ...
              {eventosFuturos.map((evento, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    ...
                    {(evento.extendedProps?.banda ||
                      evento.extendedProps?.turne) && (
