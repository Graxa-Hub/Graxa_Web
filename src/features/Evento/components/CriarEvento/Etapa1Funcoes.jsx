    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-6 py-3 rounded-[var(--radius-md)] font-semibold transition-all ${
            selectedRoles.length === 0 || !showId
              ? "bg-[var(--surface-hover)] text-[var(--text-muted)] cursor-not-allowed"
              : "bg-[var(--surface-elevated)] text-[var(--text-primary)] hover:bg-[var(--surface-hover)] shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-card)]"
          }`}
        >
